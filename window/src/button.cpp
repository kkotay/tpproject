...
Button::Button(const std::string& s, sf::Font& font, sf::Vector2f position, sf::Uint32 style) {
  m_position = position;
  ...
  switch(m_style) {
    case style::none:
    {
      m_textNormal = sf::Color(0,0,0);
      m_textHover = sf::Color(0,0,0);
      m_textClicked = sf::Color(0,0,0);
      m_bgNormal = sf::Color(0,0,0,100);
...
void Button::setStyle(sf::Uint32 style)
{
  ...
  switch(m_style)
  {
    ...
    case style::clean:
    {
      ...
      m_textHover = sf::Color(255,255,255);
      m_textClicked = sf::Color(255,255,255);
      m_bgNormal = sf::Color(240, 240,240,100);
      m_bgHover = sf::Color(200,200,200,100);
      m_bgClicked = sf::Color(255,255,255);
      m_border = sf::Color(10,10,10,100);
    }
      break;
